      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-12">
            ...
            <a href="login/daftar.php" class="themeBtn2"><i class="icon-address-card"></i> DAFTAR JADI ANGGOTA</a>
          </div>
        </div>
      </div>
    </div>  
      ...
      <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="mb-5">
              ...
              <div class="widget-content popular-posts">
                <ul>
                  <?php 
                    include 'config/koneksi.php';
                    $qTampil = mysqli_query($connect, "SELECT A.*,B.* FROM info AS A INNER JOIN kategori_info AS B ON A.kategori = B.id_kategori where kategori='1' order by id_info desc limit 7");
                    foreach($qTampil as $row){
                  ?>
                  <li>
          ...
          <div class="col-12 text-center mt-4">
            <a href="info.php" class="btn btn-success rounded py-2 px-4 text-white">Lihat Semua Info</a>
          </div>
        </div>
        </div>
      </div>
