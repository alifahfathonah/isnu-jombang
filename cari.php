            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="d-block d-md-flex listing vertical bg-success">
                  <h2 class="lh-content text-white" style="font-weight: bold; font-size: 20px;"> Hasil Pencarian Untuk : <?php echo $search;?></h2>
                </div>
                <?php 
                  if ($cek > 0) {
                ...
                <?php
                  ...
                  echo "<div class='alert alert-danger'><center>Pencarian Tidak Ada!</center></div>";
                }
                ?>
                <br><br>
              </div>
